...
description: "Full public Instagram profile by username — bio, links, counts, verification and business metadata."
---

Fetch a single public Instagram profile by its `username` (handle).
