...
description: "Paginated top-level comments on a media."
---

Page through a media's top-level `comments`.
...
<ResponseField name="items" type="Comment[]">
  A `Comment`: `pk`, `text`, `user`, `created_at`, `created_at_utc`,
