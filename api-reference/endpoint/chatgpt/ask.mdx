...
<Warning>
  Typical latency is **21–30 seconds** — this is a live answer, not a cache. Set
...
<ResponseField name="reference_tokens" type="string[]">ChatGPT's internal reference markers, e.g. `turn0search1`, `turn0news20`.</ResponseField>
...
```json Response
{
  ...
  "reference_tokens": ["turn0search0", "turn0news1"],
  "model": "gpt-5-5",
