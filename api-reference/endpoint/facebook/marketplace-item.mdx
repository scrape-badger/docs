...
<ResponseField name="location_text" type="string">Display location string, e.g. `Whitley Bay, Tyne and Wear`.</ResponseField>
<ResponseField name="city" type="string">City. Populated on feed cards only — `null` here; read `location_text`.</ResponseField>
<ResponseField name="state" type="string">State / region. Populated on feed cards only — `null` here; read `location_text`.</ResponseField>
<ResponseField name="city_page_id" type="string">
...
<ResponseField name="longitude" type="number">Approximate longitude, same source and precision as `latitude`.</ResponseField>
