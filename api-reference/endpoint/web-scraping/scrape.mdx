...
| Component | Credits |
|-----------|---------|
| HTTP engine (`curl_cffi`/`httpcloak`) | 1 |
...
| `422` | Blocking detected after all retries exhausted (`success: false`, `blocking_details` populated), or the body contained an unknown field (`error: "unknown_request_field"`) |
