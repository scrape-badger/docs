...
<ResponseField name="dispatch_time" type="string">Seller's average dispatch estimate as shown on the listing, e.g. `3 days`, `24 hours` (nullable — not every seller has one).</ResponseField>
