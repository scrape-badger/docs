---
title: "Company Jobs"
api: "GET https://scrapebadger.com/v1/linkedin/companies/{company_id}/jobs"
...
```bash cURL
curl "https://scrapebadger.com/v1/linkedin/companies/1035/jobs" \
  -H "X-API-Key: YOUR_API_KEY"
```

```javascript Node.js
const res = await fetch(
  "https://scrapebadger.com/v1/linkedin/companies/1035/jobs",
