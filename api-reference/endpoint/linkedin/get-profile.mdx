---
title: "Get Profile"
api: "GET https://scrapebadger.com/v1/linkedin/profiles/{public_id}"
...
```bash cURL
curl "https://scrapebadger.com/v1/linkedin/profiles/williamhgates" \
  -H "X-API-Key: YOUR_API_KEY"
```

```javascript Node.js
const res = await fetch(
  "https://scrapebadger.com/v1/linkedin/profiles/williamhgates",
