---
title: "Get Job"
api: "GET https://scrapebadger.com/v1/linkedin/jobs/{job_id}"
...
```bash cURL
curl "https://scrapebadger.com/v1/linkedin/jobs/3801234567" \
  -H "X-API-Key: YOUR_API_KEY"
```

```javascript Node.js
const res = await fetch(
  "https://scrapebadger.com/v1/linkedin/jobs/3801234567",
