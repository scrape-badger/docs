---
title: "Get School"
api: "GET https://scrapebadger.com/v1/linkedin/schools/{universal_name}"
...
```bash cURL
curl "https://scrapebadger.com/v1/linkedin/schools/stanford-university" \
  -H "X-API-Key: YOUR_API_KEY"
```

```javascript Node.js
const res = await fetch(
  "https://scrapebadger.com/v1/linkedin/schools/stanford-university",
