---
title: "Get Course"
api: "GET https://scrapebadger.com/v1/linkedin/learning/{course_slug}"
...
```bash cURL
curl "https://scrapebadger.com/v1/linkedin/learning/learning-python" \
  -H "X-API-Key: YOUR_API_KEY"
```

```javascript Node.js
const res = await fetch(
  "https://scrapebadger.com/v1/linkedin/learning/learning-python",
