---
title: "Get Article"
api: "GET https://scrapebadger.com/v1/linkedin/articles/{article_slug}"
...
```bash cURL
curl "https://scrapebadger.com/v1/linkedin/articles/the-future-of-cloud-jane-smith" \
  -H "X-API-Key: YOUR_API_KEY"
```

```javascript Node.js
const res = await fetch(
  "https://scrapebadger.com/v1/linkedin/articles/the-future-of-cloud-jane-smith",
