---
title: "Get Company"
api: "GET https://scrapebadger.com/v1/linkedin/companies/{universal_name}"
...
```bash cURL
curl "https://scrapebadger.com/v1/linkedin/companies/microsoft" \
  -H "X-API-Key: YOUR_API_KEY"
```

```javascript Node.js
const res = await fetch(
  "https://scrapebadger.com/v1/linkedin/companies/microsoft",
