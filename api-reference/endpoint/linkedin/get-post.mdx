---
title: "Get Post"
api: "GET https://scrapebadger.com/v1/linkedin/posts/{post_slug}"
...
```bash cURL
curl "https://scrapebadger.com/v1/linkedin/posts/activity-7212345678901234567" \
  -H "X-API-Key: YOUR_API_KEY"
```

```javascript Node.js
const res = await fetch(
  "https://scrapebadger.com/v1/linkedin/posts/activity-7212345678901234567",
