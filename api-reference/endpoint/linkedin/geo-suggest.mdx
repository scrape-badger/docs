...
api: "GET https://scrapebadger.com/v1/linkedin/geo/suggest"
...
```bash cURL
# Resolve a location
curl "https://scrapebadger.com/v1/linkedin/geo/suggest?query=London&type=geo" \
  -H "X-API-Key: YOUR_API_KEY"

# Resolve a company
curl "https://scrapebadger.com/v1/linkedin/geo/suggest?query=Microsoft&type=company" \
  -H "X-API-Key: YOUR_API_KEY"
```

```javascript Node.js
const res = await fetch(
  "https://scrapebadger.com/v1/linkedin/geo/suggest?" +
