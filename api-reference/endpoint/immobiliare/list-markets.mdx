...
```javascript Node.js
const res = await fetch("https://scrapebadger.com/v1/immobiliare/markets", {
...
res = requests.get(
    "https://scrapebadger.com/v1/immobiliare/markets",
...
```bash cURL
curl "https://scrapebadger.com/v1/immobiliare/markets" \
