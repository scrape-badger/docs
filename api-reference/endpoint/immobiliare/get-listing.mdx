...
const res = await fetch(
  "https://scrapebadger.com/v1/immobiliare/listings/121584766?market=it",
...
res = requests.get(
    "https://scrapebadger.com/v1/immobiliare/listings/121584766",
...
```bash cURL
curl "https://scrapebadger.com/v1/immobiliare/listings/121584766?market=it" \
