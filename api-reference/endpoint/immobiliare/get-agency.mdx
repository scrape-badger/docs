...
const res = await fetch(
  "https://scrapebadger.com/v1/immobiliare/agencies/41235?market=it",
...
res = requests.get(
    "https://scrapebadger.com/v1/immobiliare/agencies/41235",
...
```bash cURL
curl "https://scrapebadger.com/v1/immobiliare/agencies/41235?market=it" \
