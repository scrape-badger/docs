...
const res = await fetch(
  "https://scrapebadger.com/v1/immobiliare/market-insights/prices?" +
    new URLSearchParams({
      market: "it",
      region_id: "10",
      province_id: "MI",
...
```bash cURL
curl "https://scrapebadger.com/v1/immobiliare/market-insights/prices?market=it&region_id=10&province_id=MI&city_id=8042&contract=sale" \
