---
title: "LinkedIn Scraper by ScrapeBadger — Overview"
...
<Info>
  All endpoints are `GET`, live under `https://scrapebadger.com/v1/linkedin/*`,
...
```bash cURL
curl "https://scrapebadger.com/v1/linkedin/jobs/search?keywords=software%20engineer&location=New%20York" \
  -H "X-API-Key: YOUR_API_KEY"
```

```javascript Node.js
const res = await fetch(
  "https://scrapebadger.com/v1/linkedin/jobs/search?" +
    new URLSearchParams({
...
*ScrapeBadger is an independent tool and is not affiliated with, endorsed by, or sponsored by LinkedIn. "LinkedIn" is a trademark of LinkedIn Corporation (a Microsoft company), used here only to describe the platform this scraper is designed to work with.*
