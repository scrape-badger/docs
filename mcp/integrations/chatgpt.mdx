...
<Steps>
  ...
  <Step title="Configure Auth">
    Choose **OAuth** to sign in with your ScrapeBadger account (no key handling), or select API-key auth and paste your key.
  </Step>
</Steps>
...
Once connected, ChatGPT can call any of ScrapeBadger's 216 tools (Twitter/X, Google, YouTube, TikTok, Amazon, eBay, Reddit, real estate, web scraping) directly. Try:
