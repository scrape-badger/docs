...
ScrapeBadger provides 216 tools to OpenClaw across Twitter/X, Google, YouTube, TikTok, Amazon, eBay, Reddit, real estate, and web scraping. The Google product family alone exposes 29 tools — search, maps, news, shopping (with merchant URL enrichment), trends, jobs, hotels, patents, scholar, and more.
