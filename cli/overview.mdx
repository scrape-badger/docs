...
CLI 0.14.0 adds `scrapebadger vinted mobile-operations` and `scrapebadger vinted mobile <operation> --params <JSON>`. See [Vinted mobile API](/vinted/mobile-api) for copyable examples and all 76 operations.
