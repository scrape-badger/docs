---
title: "Zillow Scraper by ScrapeBadger — Overview"
...
<CardGroup cols={3}>
  <Card title="Multifamily Buildings" icon="building">
    Zillow's for-rent inventory is mostly apartment communities (`home_type: "BUILDING"`), which have no single price or zpid. The [`/v1/zillow/building`](/api-reference/endpoint/zillow/get-building) endpoint returns their floor plans and **every available unit** with rent, sqft, and move-in date, plus amenities, office hours, pet policy, schools, and walk/transit/bike scores.
  </Card>
...
| [`/v1/zillow/building`](/api-reference/endpoint/zillow/get-building) | GET | Multifamily building — floor plans and per-unit rents |
...
| Get multifamily building | 5 credits |
...
<CardGroup cols={2}>
  ...
  <Card title="Multifamily Building" icon="building" href="/api-reference/endpoint/zillow/get-building">
    Apartment communities — floor plans, per-unit rents, availability, amenities, and schools
  </Card>
</CardGroup>

---

*ScrapeBadger is an independent tool and is not affiliated with, endorsed by, or sponsored by Zillow. "Zillow" is a trademark of Zillow, Inc., used here only to describe the platform this scraper is designed to work with.*
